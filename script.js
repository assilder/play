...
let quiz = [
  ...
  {"question":"Quel attribut HTML définit le texte alternatif d'une image ?","options":["alt","title","src","caption"],"answer":"alt"},
  {"question":"Quelle méthode JavaScript récupère un élément par son id ?","options":["document.getElementById('id')","document.querySelectorAll('#id')","document.findById('id')","document.getElementsByClassName('id')"],"answer":"document.getElementById('id')"},
  ...
  {"question":"Quelle clause SQL permet de trier les résultats ?","options":["ORDER BY","SORT","GROUP BY","WHERE"],"answer":"ORDER BY"},
  ...
  {"question":"Quelle propriété CSS change la couleur du fond ?","options":["background-color","color","bgcolor","background"],"answer":"background-color"},
  {"question":"En SQL, quelle clause filtre les résultats ?","options":["WHERE","FROM","ORDER BY","GROUP BY"],"answer":"WHERE"},
  {"question":"Comment insérer une image en HTML ?","options":["<img src='image.jpg'>","<image src='image.jpg'>","<pic src='image.jpg'>","<photo src='image.jpg'>"],"answer":"<img src='image.jpg'>"},
  {"question":"En Java, quel mot-clé permet de gérer les exceptions ?","options":["try","catch","throw","finally"],"answer":"try"},
